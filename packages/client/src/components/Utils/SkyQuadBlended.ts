...
import shadedFs from "../shaders/skyQuadBlended.frag";
import shadedVs from "../shaders/skyQuadBlended.vert";
...
class SkyQuadBlended {
  ...
  private textures: {
    ...
    sunsetTexture: WebGLTexture | null;
    sunriseTexture: WebGLTexture | null;
  };
  ...
  public render(): void {
    ...
    if (this.shaderProgram && this.textures) {
      ...
      this.gl.uniform1i(
        this.gl.getUniformLocation(this.shaderProgram, "uTextureDay"),
        0,
      );
      ...
      this.gl.uniform1i(
        this.gl.getUniformLocation(this.shaderProgram, "uTextureNight"),
        1,
      );
      ...
      this.gl.uniform1i(
        this.gl.getUniformLocation(this.shaderProgram, "uTextureSunset"),
        2,
      );
      ...
      this.gl.uniform1i(
        this.gl.getUniformLocation(this.shaderProgram, "uTextureSunrise"),
        3,
      );

      this.gl.uniform1f(
        this.gl.getUniformLocation(this.shaderProgram, "uLightningPhase"),
        this.lightningPhase,
      );

      this.gl.uniform1f(
        this.gl.getUniformLocation(this.shaderProgram, "uDayPhase"),
        this.dayPhase,
      );
