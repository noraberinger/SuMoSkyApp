...
class Sun {
  ...
  //TODO: Radius, take center, date + time => eliptical coordinates => gc coordinate, gc vector + my center vector = observervector such that have moving vector aka translate.
  private initialPosition(positionSun: { azimuth: number; altitude: number }): {
    x: number;
    y: number;
    z: number;
  } {
