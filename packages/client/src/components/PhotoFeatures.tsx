...
import { Accordion, Typography, Grid2 as Grid, AccordionSummary, AccordionDetails } from '@mui/material/';
import { ExpandMore as ExpandMoreIcon } from '@mui/icons-material';

interface PhotoFeatureProps {
    isDTLVisible: boolean;
    sunTimes: { sunrise: string; sunset: string; goldenHourMorning: string; goldenHourEvening: string; blueHourMorning: string; blueHourEvening: string; };
 ...
 */
const PhotoFeatures: React.FC<PhotoFeatureProps> = ({isDTLVisible, sunTimes, moonTimes, isSupermoon, moonPhase}) => {
